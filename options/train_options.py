...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--sweep_id', type=str, help='sweep id for wandb hyperparameters search e.g. user/project/aweep')
        ...
        self.parser.add_argument('--lambda_recon', type=float, default=131.0, help='weight for reconstruction loss')
        self.parser.add_argument('--lambda_warp', type=float, default=131.0, help='weight for photometric loss')
        self.parser.add_argument('--lambda_consistency', type=float, default=78.0, help='weight for skip features loss')
        self.parser.add_argument('--lambda_smooth', type=float, default=159.0, help='weight for edge smoothness loss')
        self.parser.add_argument('--lambda_vgg', type=float, default=56.0, help='weight for vgg perceptual loss')
        self.parser.add_argument('--fast_train', type=int, default=0, help='initally train NVSDecoder with GT features untill valid_depth_L1_direct goes under a threshold')
