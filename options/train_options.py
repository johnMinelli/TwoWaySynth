...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--rand_el_distance', type=int, default=1, help='[ShapeNet] pairs of images will be created with a images at a random elevation distance.')
